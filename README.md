...
Berdasarkan latar belakang yang telah dijelaskan diatas, maka dapat diperoleh rumusan masalah, yaitu bagaimana membangun model Named Entity Recognition (NER) dengan menggunakan Neural Network.
